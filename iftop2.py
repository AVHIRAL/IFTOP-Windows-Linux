...
target_ip = input("Veuillez entrer l'adresse IP à scanner : ")
target_port = int(input("Veuillez entrer le port à scanner : "))
...
while True:
    ...
    sniff(prn=process_packet, filter=f"ip host {target_ip} and (tcp port {target_port} or udp port {target_port})")
